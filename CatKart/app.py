...
def customer_segmentation():
    ...
    images = [join("customer_segmentation/", f) for f in listdir("./static/customer_segmentation")]
    titles = ["Blah", "Lost Customers","Lost Cheap Customers", "Best Customers"]   
 
    return render_template('customer_segmentation.html', images=images, tables=[table1, table2, table3],
                           titles=titles)
